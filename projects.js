const GITHUB_USERNAME = "Warrick01"
...
.then(repos => {
    ...
    for(const repo of repos)
        ...
        projectTitle.texContent = repoName
        ...
        const projetContainer = document.getElementById('projects_container')

        projectsContainer.appendChild(cardContainer)
    }


}) // check the repo from discord 
